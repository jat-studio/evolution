...
void ClassScene::LoadThreeChunks(tag_id_chunks id_chunks, tag_coords_chunks coords_chunks_A, tag_coords_chunks coords_chunks_B, tag_coords_chunks coords_chunks_C){
  ClassScene::loaded_tiles[id_chunks.ida] = LoadChunk(
    ClassScene::TextureManager, int_seed, Str_To_Char_Codes(Int_To_Str(coords_chunks_A.x) + Int_To_Str(coords_chunks_A.y)), ClassScene::GetIDBiome(coords_chunks_A.x, coords_chunks_A.y, id_chunks.ida));
  ClassScene::loaded_tiles[id_chunks.idb] = LoadChunk(
    ClassScene::TextureManager, int_seed, Str_To_Char_Codes(Int_To_Str(coords_chunks_B.x) + Int_To_Str(coords_chunks_B.y)), ClassScene::GetIDBiome(coords_chunks_B.x, coords_chunks_B.y, id_chunks.idb));
  ClassScene::loaded_tiles[id_chunks.idc] = LoadChunk(
    ClassScene::TextureManager, int_seed, Str_To_Char_Codes(Int_To_Str(coords_chunks_C.x) + Int_To_Str(coords_chunks_C.y)), ClassScene::GetIDBiome(coords_chunks_C.x, coords_chunks_C.y, id_chunks.idc));
}
...
void ClassScene::ProcessMoving(unsigned short int direction){
  ...
  if (Mov_pos == Mov_border){
    ...
    if (Mov_BorderChunkCoord == Mov_BorderBiom){
      ...
      LoadBiomes(int_seed, Str_To_Char_Codes(Int_To_Str(ClassScene::coords_biomes[0].x + Mov_CoeffX)
      ...
      if (Mov_DiagonalChunkCoord1 == Mov_DiagonalBorderBiom1){
        loaded_biomes[3] = LoadBiomes(int_seed, Str_To_Char_Codes(Int_To_Str(ClassScene::coords_biomes[0].x + Mov_BiomCoeffX1) + Int_To_Str(ClassScene::coords_biomes[0].y + Mov_BiomCoeffY1)));
      }
      if (Mov_DiagonalChunkCoord2 == Mov_DiagonalBorderBiom2){
        loaded_biomes[3] = LoadBiomes(int_seed, Str_To_Char_Codes(Int_To_Str(ClassScene::coords_biomes[0].x + Mov_BiomCoeffX2) + Int_To_Str(ClassScene::coords_biomes[0].y + Mov_BiomCoeffY2)));
      }
    }
